...
export default function DeviceTable({ devices }: DeviceTableProps) {
  if (devices.length === 0) {
    return (
      <div className="flex min-h-[300px] items-center justify-center rounded-xl border border-dashed border-slate-700/50 bg-slate-800/20 px-4 py-8 text-center text-slate-400">
